...
abstract class S3Base extends WebTestCase
{
    ...
    protected DriverInterface|Storage|null $client;
    ...
    public function testUpload(): void
    {
        ...
        $this->assertTrue($this->client->delete('testing/file-1.jpg'));
    }

    public function testWrite(): void
    {
        $this->assertTrue($this->client->write('Hello World', 'text.txt'));
        $this->assertTrue($this->client->delete('text.txt'));
    }
    ...
    public function testDownload(): void
    {
        ...
        $this->assertTrue($this->client->delete('text-read.txt'));
    }
    ...
    public function testFileExists(): void
    {
        ...
        $this->assertTrue($this->client->delete('text-exist.txt'));
    }
    ...
    public function testFileSize(): void
    {
        ...
        $this->assertTrue($this->client->delete('testing/file-16.jpg'));
    }
    ...
    public function testFileMimeType(): void
    {
        ...
        $this->assertTrue($this->client->delete('testing/file-19.jpg'));
    }
}
